...
module easy_mm_interconnect_0 (
		...
		output wire [1:0]  debug_s1_address,                                      //                                        debug_s1.address
	...
	wire  [22:0] jtag_avalon_jtag_slave_agent_m0_address;                                   // jtag_avalon_jtag_slave_agent:m0_address -> jtag_avalon_jtag_slave_translator:uav_address
	...
	wire  [22:0] sram_avalon_sram_slave_agent_m0_address;                                   // sram_avalon_sram_slave_agent:m0_address -> sram_avalon_sram_slave_translator:uav_address
	...
	wire  [81:0] sram_avalon_sram_slave_agent_rf_source_data;                               // sram_avalon_sram_slave_agent:rf_source_data -> sram_avalon_sram_slave_agent_rsp_fifo:in_data
	...
	wire  [81:0] sram_avalon_sram_slave_agent_rsp_fifo_out_data;                            // sram_avalon_sram_slave_agent_rsp_fifo:out_data -> sram_avalon_sram_slave_agent:rf_sink_data
	...
	wire  [98:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> cpu_debug_mem_slave_agent:cp_data
	...
	wire  [99:0] pll_pll_slave_agent_rf_source_data;                                        // pll_pll_slave_agent:rf_source_data -> pll_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [99:0] pll_pll_slave_agent_rsp_fifo_out_data;                                     // pll_pll_slave_agent_rsp_fifo:out_data -> pll_pll_slave_agent:rf_sink_data
	...
	wire  [98:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> pll_pll_slave_agent:cp_data
	...
	wire  [22:0] timer_s1_agent_m0_address;                                                 // timer_s1_agent:m0_address -> timer_s1_translator:uav_address
	...
	wire  [98:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> timer_s1_agent:cp_data
	...
	wire  [22:0] pio_output_s1_agent_m0_address;                                            // pio_output_s1_agent:m0_address -> pio_output_s1_translator:uav_address
	...
	wire  [99:0] pio_output_s1_agent_rf_source_data;                                        // pio_output_s1_agent:rf_source_data -> pio_output_s1_agent_rsp_fifo:in_data
	...
	wire  [99:0] pio_output_s1_agent_rsp_fifo_out_data;                                     // pio_output_s1_agent_rsp_fifo:out_data -> pio_output_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> pio_output_s1_agent:cp_valid
	wire  [98:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> pio_output_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // pio_output_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> pio_output_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> pio_output_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> pio_output_s1_agent:cp_endofpacket
	...
	wire  [22:0] debug_s1_agent_m0_address;                                                 // debug_s1_agent:m0_address -> debug_s1_translator:uav_address
	...
	wire  [99:0] debug_s1_agent_rf_source_data;                                             // debug_s1_agent:rf_source_data -> debug_s1_agent_rsp_fifo:in_data
	...
	wire  [99:0] debug_s1_agent_rsp_fifo_out_data;                                          // debug_s1_agent_rsp_fifo:out_data -> debug_s1_agent:rf_sink_data
	...
	wire  [98:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> debug_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                     // debug_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> debug_s1_agent:cp_channel
	...
	wire  [80:0] sram_avalon_sram_slave_agent_rp_data;                                      // sram_avalon_sram_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [98:0] cpu_debug_mem_slave_agent_rp_data;                                         // cpu_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [98:0] pll_pll_slave_agent_rp_data;                                               // pll_pll_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [98:0] timer_s1_agent_rp_data;                                                    // timer_s1_agent:rp_data -> router_007:sink_data
	...
	wire         pio_output_s1_agent_rp_valid;                                              // pio_output_s1_agent:rp_valid -> router_008:sink_valid
	wire  [98:0] pio_output_s1_agent_rp_data;                                               // pio_output_s1_agent:rp_data -> router_008:sink_data
	wire         pio_output_s1_agent_rp_ready;                                              // router_008:sink_ready -> pio_output_s1_agent:rp_ready
	wire         pio_output_s1_agent_rp_startofpacket;                                      // pio_output_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         pio_output_s1_agent_rp_endofpacket;                                        // pio_output_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [98:0] debug_s1_agent_rp_data;                                                    // debug_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [98:0] router_src_data;                                                           // router:src_data -> cpu_data_master_limiter:cmd_sink_data
	...
	wire  [98:0] cpu_data_master_limiter_cmd_src_data;                                      // cpu_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [98:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> cpu_data_master_limiter:rsp_sink_data
	...
	wire  [98:0] router_001_src_data;                                                       // router_001:src_data -> cpu_instruction_master_limiter:cmd_sink_data
	...
	wire  [98:0] cpu_instruction_master_limiter_cmd_src_data;                               // cpu_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [98:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> cpu_instruction_master_limiter:rsp_sink_data
	...
	wire  [80:0] sram_avalon_sram_slave_burst_adapter_source0_data;                         // sram_avalon_sram_slave_burst_adapter:source0_data -> sram_avalon_sram_slave_agent:cp_data
	...
	wire   [7:0] sram_avalon_sram_slave_burst_adapter_source0_channel;                      // sram_avalon_sram_slave_burst_adapter:source0_channel -> sram_avalon_sram_slave_agent:cp_channel
	...
	wire  [80:0] router_003_src_data;                                                       // router_003:src_data -> sram_avalon_sram_slave_rsp_width_adapter:in_data
	wire         router_003_src_ready;                                                      // sram_avalon_sram_slave_rsp_width_adapter:in_ready -> router_003:src_ready
	wire   [7:0] router_003_src_channel;                                                    // router_003:src_channel -> sram_avalon_sram_slave_rsp_width_adapter:in_channel
	...
	wire  [98:0] sram_avalon_sram_slave_rsp_width_adapter_src_data;                         // sram_avalon_sram_slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire   [7:0] sram_avalon_sram_slave_rsp_width_adapter_src_channel;                      // sram_avalon_sram_slave_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire  [98:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> sram_avalon_sram_slave_cmd_width_adapter:in_data
	wire         cmd_mux_001_src_ready;                                                     // sram_avalon_sram_slave_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire   [7:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> sram_avalon_sram_slave_cmd_width_adapter:in_channel
	...
	wire  [80:0] sram_avalon_sram_slave_cmd_width_adapter_src_data;                         // sram_avalon_sram_slave_cmd_width_adapter:out_data -> sram_avalon_sram_slave_burst_adapter:sink0_data
	...
	wire   [7:0] sram_avalon_sram_slave_cmd_width_adapter_src_channel;                      // sram_avalon_sram_slave_cmd_width_adapter:out_channel -> sram_avalon_sram_slave_burst_adapter:sink0_channel
	...
	wire  [98:0] cmd_demux_src3_data;                                                       // cmd_demux:src3_data -> crosser:in_data
	...
	wire  [98:0] crosser_out_data;                                                          // crosser:out_data -> cmd_mux_003:sink0_data
	...
	wire  [98:0] rsp_demux_003_src0_data;                                                   // rsp_demux_003:src0_data -> crosser_001:in_data
	...
	wire  [98:0] crosser_001_out_data;                                                      // crosser_001:out_data -> rsp_mux:sink3_data
	...
	wire         pio_output_s1_agent_rdata_fifo_src_valid;                                  // pio_output_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] pio_output_s1_agent_rdata_fifo_src_data;                                   // pio_output_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         pio_output_s1_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_006:in_0_ready -> pio_output_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> pio_output_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> pio_output_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                         // pio_output_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> pio_output_s1_agent:rdata_fifo_sink_error
	...
	easy_mm_interconnect_0_router router (
	...
	easy_mm_interconnect_0_router_001 router_001 (
	...
	easy_mm_interconnect_0_router_002 router_002 (
	...
	easy_mm_interconnect_0_router_003 router_003 (
	...
	easy_mm_interconnect_0_router_004 router_004 (
	...
	easy_mm_interconnect_0_router_002 router_005 (
	...
	easy_mm_interconnect_0_router_004 router_006 (
	...
	easy_mm_interconnect_0_router_002 router_007 (
	...
	easy_mm_interconnect_0_router_002 router_008 (
	...
	easy_mm_interconnect_0_router_002 router_009 (
	...
	easy_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (pll_c0_clk),                                    //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	easy_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (pll_c0_clk),                                           //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	easy_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (pll_c0_clk),                            //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (pll_c0_clk),                            //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (pll_c0_clk),                            //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                         //       clk.clk
		.reset               (pll_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (pll_c0_clk),                            //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (pll_c0_clk),                            //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (pll_c0_clk),                            //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (pll_c0_clk),                            //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (pll_c0_clk),                            //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (pll_c0_clk),                                                 //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),                      // clk_reset.reset
	...
	easy_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (pll_c0_clk),                            //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                         //       clk.clk
		.reset              (pll_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_rsp_demux_001 rsp_demux_004 (
		.clk                (pll_c0_clk),                            //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (pll_c0_clk),                            //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (pll_c0_clk),                            //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (pll_c0_clk),                            //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (pll_c0_clk),                            //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (pll_c0_clk),                            //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	easy_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	easy_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
