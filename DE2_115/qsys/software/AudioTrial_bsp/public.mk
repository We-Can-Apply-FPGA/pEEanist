...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10411070
SOPC_SYSID_FLAG += --sidp=0x10411070
ELF_PATCH_FLAG  += --sidp 0x10411070

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1450710416
SOPC_SYSID_FLAG += --timestamp=1450710416
ELF_PATCH_FLAG  += --timestamp 1450710416
